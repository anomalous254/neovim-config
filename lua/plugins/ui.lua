return {
...

  {
    ...
    keys = {
      ...
      { '<leader>fe', ':NvimTreeFocus<CR>', desc = 'Focus file tree' },
    },
    config = function()
      require('nvim-tree').setup {
        ...
        view = {
          ...
          side = 'left',
          mappings = {
            custom_only = false, -- keep default mappings + custom
            list = {
              { key = 'a', action = 'create' },    -- create new file/folder
              { key = 'r', action = 'rename' },    -- rename file/folder
              { key = 'd', action = 'remove' },    -- delete
              { key = 'x', action = 'cut' },
              { key = 'c', action = 'copy' },
              { key = 'p', action = 'paste' },
              { key = '<CR>', action = 'edit' },   -- open file
